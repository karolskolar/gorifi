...
- Known duplication: `GuestOrder.vue` copies the `FriendOrder.vue` product grid. GSO-T4 needs the same grid — extract a shared component before a third copy appears.
